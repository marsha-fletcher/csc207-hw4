...
public class FractionTest {
    ...
    Fraction test3 = new Fraction(BigInteger.valueOf(3), BigInteger.valueOf(2));
	...
	assertEquals(BigInteger.valueOf(5), test2.numerator); //Fraction(int num) test
	assertEquals(BigInteger.valueOf(1), test2.denominator); //Fraction(int num) test
	assertEquals(BigInteger.valueOf(3), test4.numerator); //Fraction(double val) test
	assertEquals(BigInteger.valueOf(4), test4.denominator); //Fraction(double val) test
